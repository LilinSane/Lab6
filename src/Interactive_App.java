...
public class Interactive_App {
     ...
     * @param hashSet
     */
    public static void add( HashSet<LabWork> hashSet){
     ...
     * @param id
     */
    public static Server_response update_id(HashSet<LabWork> hashSet, long id, LabWork client_labWork){
        boolean flag = false;
     ...
     * @param id
     */
    public static Server_response remove_by_id(HashSet<LabWork> hashSet, long id){
        Server_response response = new Server_response();
        boolean flag = false;
        for (LabWork lab : hashSet) {
            if (lab.getId() == id) {
     ...
     * @param hashSet
     */
    public static Server_response clear(HashSet<LabWork> hashSet){
        hashSet.clear();
        Server_response response = new Server_response();
     ...
     * @return
     */
    public static Server_response help(){
        Server_response response = new Server_response();
     ...
     * @param filename
     */
    public static void save(HashSet<LabWork> hashSet, String filename){
     ...
     * @param hashSet
     */
    public static Server_response add_if_max(HashSet<LabWork> hashSet, LabWork client_labwork){
        Server_response response = new Server_response();
     ...
     * @param hashSet
     */
    public static Server_response add_if_min(HashSet<LabWork> hashSet, LabWork client_labwork){
        Server_response response = new Server_response();
     ...
     * @param hashSet
     */
    public static Server_response remove_lower(HashSet<LabWork> hashSet, LabWork client_labwork){
        Server_response response = new Server_response();
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
     ...
     * @param hashSet
     */
    public static Server_response min_by_creation_date(HashSet<LabWork> hashSet){
        Server_response response = new Server_response();
        long min = 0;
        long max = 0;
        for (LabWork lab : hashSet){
     ...
     * @param name
     */
    public static Server_response filter_starts_with_name(HashSet<LabWork> hashSet, String name){
        Server_response response = new Server_response();
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        String content = " ";
        boolean flag = true;
     ...
     * @param hashSet
     */
    public static Server_response print_field_descending_average_point(HashSet<LabWork> hashSet){
        Server_response response = new Server_response();
        String content = " ";
     ...
     * @param hashSet
     */
    public static Server_response show(HashSet<LabWork> hashSet){
        Server_response response = new Server_response();
     ...
     * @param ini_Date
     */
    public static Server_response info(HashSet<LabWork> hashSet, Date ini_Date){
        Server_response response = new Server_response();
    ...
    static void execute_script(HashSet<LabWork> labWorks, String scriptname, Date ini_date, DatagramSocket ds, byte[] sending_data, DatagramPacket receiving_dp, byte[] receiving_data, int timeout){
            ...
            try {
                ...
                if (cl[0].equals("add")){
                    ...
                    if (cl[1].matches("[1-9]{1}[0-9]{5}")) {
                        ...
                        labWorks.add(lab);
                        client_cm = new Command();
                        client_cm.setCm_name(cl[0] + " " + cl[1]);
                        Stream<LabWork> stream = labWorks.stream();
                        client_cm.setLabWork(stream.findFirst().orElse(null));
                        labWorks.clear();
    ...
    public static TreeSet sort_collection(HashSet<LabWork> hashSet){
